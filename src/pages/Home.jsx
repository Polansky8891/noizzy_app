...
export const Home = () => {
  ...
  return (
    <div className="w-full h-full bg-black rounded-3xl">
      <h2 className="text-3xl font-exo font-light text-[#AC4BEB] mb-5">Top genres</h2>
        ...
        {genres.map(g => (
          <div key={g.slug} className="flex flex-col items-center">
            <Link
              ...
              aria-label={g.name}
            >
              <span className="pointer-events-none absolute inset-0 rounded-2xl border border-white/12 shadow-[0_0_14px_rgba(255,255,255,0.07)] group-hover:border-white/25 group-hover:shadow-[0_0_22px_rgba(255,255,255,0.12)]" />
